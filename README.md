...
## Contents
- [Linux Privilege Escalation](privilege-escalation/blob/main/linux-privilege-escalation.md) — manual and automated enumeration, credential discovery, writable jobs/paths, SUID/sudo, and kernel angles.
