...
## Contents
- [Linux Privilege Escalation](linux-privilege-escalation.md) — manual and automated enumeration, credential discovery, writable jobs/paths, SUID/sudo, and kernel angles.
- [Windows Privilege Escalation](windows-privilege-escalation.md) — privilege model essentials, situational awareness, service/DLL path hijacking, scheduled tasks, and exploit pointers.
